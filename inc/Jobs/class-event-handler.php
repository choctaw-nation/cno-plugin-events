...
class Event_Handler {
	...
	private function get_is_event_expired( int $event_id ): bool {
		$is_all_day = get_field( 'event_details_time_and_date_is_all_day', $event_id );
		$start_date = get_field( 'event_details_time_and_date_start_date', $event_id );
		$start_time = get_field( 'event_details_time_and_date_start_time', $event_id );
		$end_date   = get_field( 'event_details_time_and_date_end_date', $event_id );
		$end_time   = get_field( 'event_details_time_and_date_end_time', $event_id );
		if ( $is_all_day ) {
